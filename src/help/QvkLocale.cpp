...
#ifdef Q_OS_LINUX
    vkDownload->doDownload( QUrl( "https://vokoshowclick.volkoh.de/3.0/help/getLinuxDirs.php" ) );
#endif
#ifdef Q_OS_WIN
    vkDownload->doDownload( QUrl( "https://vokoshowclick.volkoh.de/3.0/help/getWindowsDirs.php" ) );
#endif
