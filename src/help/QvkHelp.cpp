 ...
 * The first section is help, this we need for set for installEventFilter, see constructor.
...
QvkHelp::QvkHelp(QMainWindow *mainWindow, Ui_MainWindow *ui_mainwindow ) : uiHelp(new(Ui::help))
{
