...
QvkLicenses::QvkLicenses() : ui( new Ui::license )
{
    ...
    setPictureAndLicense( ":/pictures/" );
    setPictureAndLicense( ":/spezialCheckBox/" );
}
...
void QvkLicenses::setPictureAndLicense( QString path )
{
    QDirIterator dirIterator_1( path, QDir::Files, QDirIterator::Subdirectories );
